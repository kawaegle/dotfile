...
But you can already find my NVim's configuration documentation [here](https://github.com/kawaegle/Dotfiles/blob/main/nvim/README.md).

## Installation

The fast easy way to install that dotfile is to use [dossier](https://github.com/oppaiweeb/dossier) but have a look before applying them.
